...
export function GetAJobEventDescriptionComponent(){
	return(<>
		<Card className="w-100" style={{marginTop:-40}}>
  						<Card.Header style={{height:150}}  size="lg"></Card.Header>
  							...
  							<Card.Body className="ms-3">
    							<Card.Title>Advance Microsoft teams Webinar for Assistants and Admins</Card.Title>
    							<br />
    							<Row md={12}>
								    <Col sm={5} xs={5} md={5} lg={5}><img src={buildingIcon} /><label className="ms-2">Wed, Apr 21,8:00 PM EEST</label></Col>|
    							...
    							<Row md={12}>
								    <Col sm={2} xs={2} md={2} lg={2}><Button className="btn-warning ">Sketch</Button></Col>
								    <Col sm={5} xs={5} md={5} lg={3}><Button className="ms-1" variant="outline-warning">Photoshop</Button></Col>
								    <Col sm={5} xs={5} md={5} lg={2}><Button className="ms-1" variant="outline-dark">Figma</Button></Col>
							    </Row>
